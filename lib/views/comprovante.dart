            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  Text("Valor pago", style: TextStyle(color: Colors.grey)),
                  Text(
                    "R\$ 0,01",
                  ...
                  Text(
                    "Gabrielle Faustino Ocampos",
                    style: TextStyle(fontSize: 16),
                  ),
                  SizedBox(height: 10),
                  Text("CPF", style: TextStyle(color: Colors.grey)),
                  Text("***.777.401-**", style: TextStyle(fontSize: 16)),
                  SizedBox(height: 10),
                  Text("Instituição", style: TextStyle(color: Colors.grey)),
                  Text("NU PAGAMENTOS - IP", style: TextStyle(fontSize: 16)),
                  SizedBox(height: 10),
                  Divider(),
                  SizedBox(height: 10),
                  Text("ID/Transação", style: TextStyle(color: Colors.grey)),
                  Text("Lazaro Barbosa", style: TextStyle(fontSize: 16)),
                  SizedBox(height: 10),
                  Text(
                    "Data e hora da transação",
                    style: TextStyle(color: Colors.grey),
                  ),
                  Text("23/07/2025 - 11:17:35", style: TextStyle(fontSize: 16)),
                  SizedBox(height: 10),
                  Text(
                    "Código de autenticação",
                    style: TextStyle(color: Colors.grey),
                  ),
                  Text("AS67A5S67AD7SGDA67FA", style: TextStyle(fontSize: 16)),
                  SizedBox(height: 10),
                  Divider(),
                ],
              ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(5),
                  border: Border.all(color: Color.fromARGB(255, 236, 9, 0)),
                ),
                child: Text(
                  "Fazer novo Pix",
                  style: TextStyle(
