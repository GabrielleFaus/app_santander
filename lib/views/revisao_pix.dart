          ...
          children: [
            Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Text("Para", style: TextStyle(fontSize: 18)),
                    SizedBox(width: 5),
                    Text(
                ...
                Divider(),
                SizedBox(height: 10),
                Text("Valor", style: TextStyle(color: Colors.grey.shade800)),
                Text(
                  "R\$ 1.000.000,00",
                ...
                Text("Ag 4317 Cc 01010101-8", style: TextStyle(fontSize: 16)),
                SizedBox(height: 10),
                Text(
                  "Data de envio",
                  style: TextStyle(color: Colors.grey.shade800),
            ...
            GestureDetector(
              onTap: () {
                Navigator.of(
                  context,
                ).push(MaterialPageRoute(builder: (_) => Comprovante()));
              },
              child: Container(
